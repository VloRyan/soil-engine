...
namespace soil_samples::gui {
    ShapeTileInstanceShader::ShapeTileInstanceShader(const std::string& path) : Shader(NAME, path), viewer_(nullptr) {}
    ...
    void ShapeTileInstanceShader::SetViewer(soil::stage::scene::viewer::Node* const viewer) {
        viewer_ = viewer;
    }
