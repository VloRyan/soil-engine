...
std::vector<soil::video::vertex::VertexAttribDescriptor>
    ShapeTileInstance::ATTRIBS = {
        ...
        {.Elements = 1,
         .Type = soil::video::vertex::AttributePointer::DataType::Int},
...
int ShapeTileInstance::GetTileIndex() const { return data_.TileIndex; }
...
glm::vec2 ShapeTileInstance::GetSize() const { return data_.Size; }
