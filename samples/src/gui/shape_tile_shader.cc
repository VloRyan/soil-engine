...
namespace soil_samples::gui {
    ShapeTileShader::ShapeTileShader(const std::string& path) : Shader(NAME, path), viewer_(nullptr) {}
    ...
    void ShapeTileShader::SetViewer(soil::stage::scene::viewer::Node* const viewer) {
        viewer_ = viewer;
    }
