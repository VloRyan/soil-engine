...
namespace soil_samples::instancing {
    ...
    Stage::Stage(soil::stage::Manager *manager) : soil::stage::Stage(manager), shapes_(), printStatistics_(false) {
        ...
        const std::vector textures = {GetResources().GetTexture2D("Textures/soil.png", {}),
        ...
        auto *instancing = scene->AddComponentFeature(new soil::stage::scene::render::Instancing());
        instancing->AddRenderBatch("Shape",
