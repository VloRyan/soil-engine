...
namespace soil_samples::line {
    ...
    LineInstance::LineInstance(const std::string& batchKey, const glm::vec3 StartPoint, const glm::vec3 EndPoint) :
        InstanceData(batchKey, true), data_({
                                          .Start = StartPoint,
                                          .End = EndPoint,
                                          .Color = glm::vec4(1.0F),
                                      }),
        localStartPoint_(StartPoint), localEndPoint_(EndPoint) {}
    ...
    glm::vec4 LineInstance::GetColor() const {
        return data_.Color;
    }
    ...
    glm::vec3 LineInstance::GetEndPoint() const {
