...
namespace soil::stage::scene::gui::container {
    ...
    TEST_F(VBoxTest, Update) {
        ...
        EXPECT_VEC_EQ(child->GetPosition(), glm::vec3(0.F, 250.F, Rectangle::LAYER_Z_INCREMENT));
        ...
        EXPECT_VEC_EQ(box.GetSize(), glm::ivec2(800, 600));
        EXPECT_VEC_EQ(child->GetPosition(), glm::vec3(0.F, 250.F, Rectangle::LAYER_Z_INCREMENT));
        EXPECT_VEC_EQ(child2->GetPosition(), glm::vec3(0.F, 150.F, Rectangle::LAYER_Z_INCREMENT));
        ...
        EXPECT_VEC_EQ(box.GetSize(), glm::ivec2(800, 600));
        EXPECT_VEC_EQ(child->GetPosition(), glm::vec3(0.F, 250.F, Rectangle::LAYER_Z_INCREMENT));
        EXPECT_VEC_EQ(child2->GetPosition(), glm::vec3(0.F, 150.F - margin, Rectangle::LAYER_Z_INCREMENT));
        EXPECT_VEC_EQ(child3->GetPosition(), glm::vec3(0.F, 25.F - 2 * margin, Rectangle::LAYER_Z_INCREMENT));
        ...
        EXPECT_VEC_EQ(box.GetItemsSize(), glm::ivec2(150, 350 + 2 * margin));
        EXPECT_VEC_EQ(box.GetSize(), glm::ivec2(800, 600));
        EXPECT_VEC_EQ(child->GetPosition(), glm::vec3(0.F, 250.F + offset, Rectangle::LAYER_Z_INCREMENT));
        EXPECT_VEC_EQ(child2->GetPosition(), glm::vec3(0.F, 150.F + offset - margin, Rectangle::LAYER_Z_INCREMENT));
        EXPECT_VEC_EQ(child3->GetPosition(), glm::vec3(0.F, 25.F + offset - 2 * margin, Rectangle::LAYER_Z_INCREMENT));
    }
    ...
    TEST_F(VBoxTest, UpdateAlign) {
        ...
        EXPECT_VEC_EQ(box.GetItemsSize(), glm::ivec2(100));
        EXPECT_VEC_EQ(box.GetSize(), glm::ivec2(800, 600))
        EXPECT_VEC_EQ(child->GetPosition(), glm::vec3(-340.F, 250.F, Rectangle::LAYER_Z_INCREMENT));

        box.SetAlignItems(VBox::AlignItems::Center);
        box.Update();
        EXPECT_VEC_EQ(child->GetPosition(), glm::vec3(-10.F, 250.F, Rectangle::LAYER_Z_INCREMENT));

        box.SetAlignItems(VBox::AlignItems::Right);
        box.Update();
        EXPECT_VEC_EQ(child->GetPosition(), glm::vec3(330.F, 250.F, Rectangle::LAYER_Z_INCREMENT));
    }
