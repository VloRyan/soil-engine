...
namespace soil::world::volume {
    ...
    protected:
        ...
        glm::mat4 BuildOrthoHeightPerspective(glm::ivec2 size, float orthoSize = 10.F) {
            float aspect = 0.F;
    ...
    TEST_F(FrustumTest, Constructor) {
        ...
        const auto view = glm::lookAt(glm::vec3(0.F), glm::vec3(0.F, 0.F, -1.F), glm::vec3(0.F, 1.F, 0.F));
    ...
    TEST_F(FrustumTest, IsVisible_Vector) {
        ...
        const auto view = glm::lookAt(glm::vec3(0.F), glm::vec3(0.F, 0.F, -1.F), glm::vec3(0.F, 1.F, 0.F));
        const Frustum frustum(projection * view);
        const auto invisibleBox = MakeAABB(glm::vec3(5.F), glm::vec3(1.F)); // Pos is behind viewer
    ...
    TEST_F(FrustumTest, IntersectBox) {
        const auto projection = glm::ortho(-5.F, 5.F, -5.F, 5.F, 0.01F, 25.F);
        auto view = glm::lookAt(glm::vec3(0, 10, 10), glm::vec3(0, 0, -1), glm::vec3(0.F, 1.F, 0.F));
        Frustum frustum(projection * view);
        const auto box = MakeAABB(glm::vec3(5.F, 5.F, -5.F), glm::vec3(10.F));
        const auto outsideBox = MakeAABB(glm::vec3(16.0F, 16.0F, -16.0F), glm::vec3(10.F));
        ...
        view = glm::lookAt(glm::vec3(28.750F, 10.F, 25.F), glm::vec3(28.750F, 00.F, 14.F), glm::vec3(0.F, 1.F, 0.F));
        ...
        for (auto i = 0; i < 6; i++) {
            ...
            std::cout << "Plain(" << std::to_string(i) << "): " << util::Strings::to_string(plain) << "\n";
        }*/
    }
