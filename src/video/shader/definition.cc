...
Definition::Definition(std::string vertexShaderName,
                       std::string fragmentShaderName)
    : vertexShaderName_(std::move(vertexShaderName)),
...
void Definition::SetTessellationEvalStageShaderName(
    std::string TessellationEvalStageShaderName) {
...
void Definition::SetTessellationControlShaderName(
    const std::string &TessellationControlShaderName) {
