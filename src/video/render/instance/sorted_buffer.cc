...
namespace soil::video::render::instance {
    SortedBuffer::SortedBuffer(buffer::Object *buffer, const size_t instanceSize, const SortType sortType) :
    ...
    glm::vec3 SortedBuffer::GetRefPos() const {
        return refPos;
    }

    void SortedBuffer::SetRefPos(const glm::vec3 &ref_pos) {
        refPos = ref_pos;
    }
} // namespace soil::video::render::instance
