...
void Data::SetData(
    const byte* data, const size_t dataSize,
...
vertex::IndexType Data::GetIndexType() const { return indexType_; }

byte* Data::GetIndices() const { return indices_; }

byte* Data::GetData() const { return data_; }
...
const std::vector<vertex::VertexAttribDescriptor>& Data::GetVertexAttribs()
    const {
...
uint Data::GetIndexCount() const { return indexCount_; }
