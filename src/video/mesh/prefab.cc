        ...
        case Type::Line:
            {
                ...
                meshData->SetData(reinterpret_cast<const byte *>(vertices), sizeof(glm::vec2),
        ...
        case Type::Quad:
            {
                ...
                /*return new Data(id, indices, 6, shader::DrawMode::Triangles, reinterpret_cast<const byte *>(vertices),
