...
namespace soil::stage::scene::component {
    AABB::AABB(const glm::vec3 dimension, const glm::vec3 scale) :
        points_(), worldPoints_(), scale_(scale), minPoint_(), debugDrawer_(nullptr), firstLineId(-1), maxPoint_() {
        contactTypes_.set();
    ...
    void AABB::GetAllPoints(std::array<glm::vec4, 8> points) const { std::ranges::copy(worldPoints_, points.begin()); }
    ...
    glm::vec3 AABB::GetPoint(const Point point) const { return worldPoints_[static_cast<int>(point)]; }
    ...
    IntersectionResult AABB::IntersectsRay2d(const glm::vec2 start, const glm::vec2 dir) const {
    ...
    void AABB::DrawDebugLines(IDebugDrawer *debugDrawer) {
        ...
        debugDrawer->Line(points_[static_cast<int>(Point::TOP_FRONT_LEFT)],
                          points_[static_cast<int>(Point::TOP_FRONT_RIGHT)], glm::vec4(1.0F));

        debugDrawer->Line(points_[static_cast<int>(Point::TOP_FRONT_RIGHT)],
                          points_[static_cast<int>(Point::BOTTOM_FRONT_RIGHT)], glm::vec4(1.0F));

        debugDrawer->Line(points_[static_cast<int>(Point::BOTTOM_FRONT_RIGHT)],
                          points_[static_cast<int>(Point::BOTTOM_FRONT_LEFT)], glm::vec4(1.0F));

        debugDrawer->Line(points_[static_cast<int>(Point::BOTTOM_FRONT_LEFT)],
                          points_[static_cast<int>(Point::TOP_FRONT_LEFT)], glm::vec4(1.0F));
        // BACK
        debugDrawer->Line(points_[static_cast<int>(Point::TOP_BACK_LEFT)],
                          points_[static_cast<int>(Point::TOP_BACK_RIGHT)], glm::vec4(1.0F));

        debugDrawer->Line(points_[static_cast<int>(Point::TOP_BACK_RIGHT)],
                          points_[static_cast<int>(Point::BOTTOM_BACK_RIGHT)], glm::vec4(1.0F));

        debugDrawer->Line(points_[static_cast<int>(Point::BOTTOM_BACK_RIGHT)],
                          points_[static_cast<int>(Point::BOTTOM_BACK_LEFT)], glm::vec4(1.0F));

        debugDrawer->Line(points_[static_cast<int>(Point::BOTTOM_BACK_LEFT)],
                          points_[static_cast<int>(Point::TOP_BACK_LEFT)], glm::vec4(1.0F));
        // EDGES
        debugDrawer->Line(points_[static_cast<int>(Point::TOP_FRONT_LEFT)],
                          points_[static_cast<int>(Point::TOP_BACK_LEFT)], glm::vec4(1.0F));
        debugDrawer->Line(points_[static_cast<int>(Point::TOP_FRONT_RIGHT)],
    ...
    bool AABB::IsContactType(ContactType contactType) const { return contactTypes_[static_cast<int>(contactType)]; }

    void AABB::SetContactType(ContactType type, const bool value) { contactTypes_[static_cast<int>(type)] = value; }
} // namespace soil::stage::scene::component
