...
namespace soil::stage::scene::component {
    ListenerComponent::ListenerComponent(sound::Listener* listener, const bool setOrientation) :
        Component(Type::Sound), listener_(listener), setOrientation_(setOrientation) {
    }

    sound::Listener* ListenerComponent::GetListener() const {
        return listener_;
    }
