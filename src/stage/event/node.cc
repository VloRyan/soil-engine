...
namespace soil::stage::event {
    ...
    Node::ChangeType Node::GetChangeType() const {
        return changeType_;
    }

    scene::Node* Node::GetOrigin() const {
        return origin_;
    }

    scene::Node* Node::GetChangedNode() const {
        return changedNode_;
    }

    const Component& Node::GetComponentEvent() const {
    ...
    Node Node::MakeComponentEvent(scene::Node* origin, const Component& componentEvent) {
