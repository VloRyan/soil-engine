...
namespace soil::world::entity {
    ...
    glm::vec3 Object3d::GetPosition() const {
        return {localTransform_[3]};
    }

    glm::vec3 Object3d::GetWorldPosition() const {
        return {worldTransform_[3]};
    }
    ...
    glm::vec3 Object3d::GetDirection() const {
        return localTransform_[2];
    }

    void Object3d::SetDirection(const glm::vec3& direction) {
        localTransform_[2] = glm::vec4(direction, 1.0F);
    }

    glm::vec3 Object3d::GetUp() const {
        return {localTransform_[1]};
    }

    void Object3d::SetUp(const glm::vec3& up) {
        localTransform_[1] = glm::vec4(up, 1.0F);
    }

    glm::vec3 Object3d::GetRight() const {
        return {localTransform_[0]};
    }

    void Object3d::SetRight(const glm::vec3& right) {
        localTransform_[0] = glm::vec4(right, 1.0F);
    }

    void Object3d::SetLocalTransform(const glm::mat4& Transform) {
        localTransform_ = Transform;
    }

    const glm::mat4& Object3d::GetLocalTransform() const {
