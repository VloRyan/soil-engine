...
void QuadTree::QueryVolumesAt(const glm::vec3& point,
                              std::vector<const Volume*>& volumes) const {
  QueryVolumesAt({point.x, point.z}, volumes);
}

void QuadTree::QueryVolumesAt(const glm::vec2& point,
                              std::vector<const Volume*>& volumes) const {
...
void QuadTree::QueryNodeIndicesFor(const Volume* volume,
