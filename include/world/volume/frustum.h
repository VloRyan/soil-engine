...
namespace soil::world::volume {
    enum class Planes : std::uint8_t { Left = 0, Right, Top, Bottom, Near, Far, COUNT };
    ...
    public:
        ...
        [[nodiscard]] bool IsVisible(Planes plane, const glm::vec3 &min, const glm::vec3 &max) const;
        [[nodiscard]] bool IntersectBox(const glm::vec3 &min, const glm::vec3 &max) const;
