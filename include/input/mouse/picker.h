...
class Picker final {
 public:
  static glm::vec3 CalculateRay(const glm::uvec2& mousePos,
 ...
 private:
  ...
  static glm::vec2 getNormalisedDeviceCoordinates(const glm::uvec2& mousePos,
                                                  const glm::uvec2& windowSize);

  static glm::vec3 toWorldCoords(const glm::vec4& eyeCoords,
                                 const glm::mat4& viewMatrix);

  static glm::vec4 toEyeCoords(const glm::vec4& clipCoords,
