...
namespace soil::util {
    ...
    public:
         ...
         * @return string in format (x, y)
         */
        static std::string to_string(glm::ivec2 value, const std::string& delimiter = ", ",
                                     bool surroundingParentheses = true);

        /**
         * @return string in format (x, y, z)
         */
        static std::string to_string(glm::ivec3 value, const std::string& delimiter = ", ",
                                     bool surroundingParentheses = true);

        /**
         * @return string in format (x, y, z, w)
         */
        static std::string to_string(glm::ivec4 value, const std::string& delimiter = ", ",
                                     bool surroundingParentheses = true);
