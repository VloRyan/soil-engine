...
class Strings {
 public:
  /**
   * @return <code>option[0]</code> if <code>value</code> is false, else
   * <code>option[1]</code>
   */
  static std::string to_string(bool value,
                               std::array<std::string, 2> options = {"yes",
                                                                     "no"});
   ...
   * @return string in format (x, y)
   */
  static std::string to_string(glm::vec2 value, int precision = 3,
   ...
   */
  static std::string to_string(glm::vec3 value, int precision = 3,
                               const std::string& delimiter = ", ",
                               bool surroundingParentheses = true);
   ...
   */
  static std::string to_string(glm::vec4 value, int precision = 3,
                               const std::string& delimiter = ", ",
                               bool surroundingParentheses = true);
   ...
   * @return string in format (x, y)
   */
  static std::string to_string(glm::ivec2 value,
                               const std::string& delimiter = ", ",
                               bool surroundingParentheses = true);
   ...
   * @return string in format (x, y, z)
   */
  static std::string to_string(glm::ivec3 value,
                               const std::string& delimiter = ", ",
                               bool surroundingParentheses = true);
   ...
   * @return string in format (x, y, z, w)
   */
  static std::string to_string(glm::ivec4 value,
                               const std::string& delimiter = ", ",
                               bool surroundingParentheses = true);
   ...
   * @return string in format "(x, y, z, w)\n" for each row
   */
  static std::string to_string(const glm::mat4& matrix, int precision = 3,
                               const std::string& delimiter = ", ",
                               bool surroundingParentheses = true);
  ...
  static glm::vec2 to_vec2(const std::string& str,
                           const std::string& delimiter = ",");

  static glm::vec3 to_vec3(const std::string& str,
                           const std::string& delimiter = ",");

  static glm::vec4 to_vec4(const std::string& str,
                           const std::string& delimiter = ",");

  static glm::uvec2 to_uvec2(const std::string& str,
                             const std::string& delimiter = ",");

  static glm::uvec3 to_uvec3(const std::string& str,
                             const std::string& delimiter = ",");

  static glm::uvec4 to_uvec4(const std::string& str,
                             const std::string& delimiter = ",");
