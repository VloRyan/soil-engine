#ifndef SOIL_STAGE_SCENE_QUAD_TREE_H_
#define SOIL_STAGE_SCENE_QUAD_TREE_H_
...
namespace soil::stage::scene::space {
    ...
    public:
        struct Node {
            ...
            explicit Node(const int32_t parentIndex, const int32_t level, const glm::vec2 &center, const float radius) :
                ParentIndex(parentIndex), FirstChildIndex(-1), Level(level), Min(glm::vec2(center - radius)),
...
#endif // SOIL_STAGE_SCENE_QUAD_TREE_H_
