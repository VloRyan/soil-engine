...
class AttributePointer final {
 public:
   ...
   * floats -> elementSize = 3
   * @param elementStride Specifies the byte offset between consecutive generic
   ...
   * @param divisor Specify the number of instances_ that will pass between
   * updates of the generic attribute. 0 = per Vertex, 1 = per every Instance, 2
   * = per every second instance and so on
   * @param offset Specifies a offset of the first component of the first
