...
namespace video::shader {
 ...
 public:
  ...
  static void DrawElementsInstanced(uint mode,
                                    uint indexCount,
  ...
  static void SetTextures(GLenum target, const std::vector<texture::Texture *> &textures, UniformLocation location,
                          byte maxTextures = 32);

  static void SetTexture(GLenum target, byte textureUnit, const texture::Texture *texture, UniformLocation location);
