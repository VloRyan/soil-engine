...
class Sort : public Base {
 public:
  ...
  explicit Sort(const std::string& id, Order order = Order::FrontToBack,
 ...
 private:
  static void sortFrontToBack(const glm::vec3& refPoint,
                              std::vector<RenderableObject*>& renderables);

  static void sortBackToFront(const glm::vec3& refPoint,
                              std::vector<RenderableObject*>& renderables);
